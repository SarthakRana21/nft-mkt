    ...
    <div className='mt-[10rem] md:mt-[9rem] lg:mt-[10rem] w-full flex justify-center flex-col'>
      <div className="w-4/5 mx-auto items-center grid lg:grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="col-span-2">
          <h1 className='text-2xl sm:text-4xl lg:text-5xl xl:text-6xl text-blue-900 font-bold text-center lg:text-left mt-8'>Buy, Sell and Collect NFTs</h1>
          <p className="text-sm md:text-[17px] text-gray-700 text-opacity-80 mt-4 font-medium text-center lg:text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam impedit incidunt possimus suscipit ad iste, fugit culpa voluptatum sed, earum est, iusto molestiae qui vel ut rerum quos! Unde, cum?</p>
